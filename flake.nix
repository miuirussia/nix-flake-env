{
  ...
  inputs = {
    nixpkgs = { url = "github:miuirussia/nixpkgs/911217df3b2a31f0cbb4b4e67e0cc87492253456"; };
    nixUnstable = { url = "github:NixOS/nix/ed3bc63666732bdc0724f2e53c14935a9f0f6fe7"; inputs.nixpkgs.follows = "nixpkgs"; };
