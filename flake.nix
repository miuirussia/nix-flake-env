{
  ...
  inputs = {
    nixpkgs = { url = "github:miuirussia/nixpkgs/05105776ffce15fba66d2560341e994889d9665b"; };
    nixUnstable = { url = "github:NixOS/nix/558c4ee3e370c9f9a6ea293df54ed6914a999f1c"; inputs.nixpkgs.follows = "nixpkgs"; };
