{
  ...
  inputs = {
    nixpkgs = { url = "github:miuirussia/nixpkgs/3895cdd8dc2d76205e5c36879d5a63795682e915"; };
    nixUnstable = { url = "github:NixOS/nix/c9a4ddb9c0a7d15c29d904a017d4d5d58492fdfd"; inputs.nixpkgs.follows = "nixpkgs"; };
