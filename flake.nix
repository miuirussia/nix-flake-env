{
  ...
  inputs = {
    nixpkgs = { url = "github:miuirussia/nixpkgs/49c6ed255d83dab16679e8f767a185d4d1a31851"; };
    nixUnstable = { url = "github:NixOS/nix/f71d84672b6880634434f58c809c1341499e45e5"; inputs.nixpkgs.follows = "nixpkgs"; };
