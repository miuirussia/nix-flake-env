{
  ...
  inputs = {
    nixpkgs = { url = "github:miuirussia/nixpkgs/0f97f1247dd4dc6fbccedc6afbcefb4cd9c2c75f"; };
    nixUnstable = { url = "github:NixOS/nix/52f52319ad21bdbd7a33bb85eccc83756648f110"; inputs.nixpkgs.follows = "nixpkgs"; };
